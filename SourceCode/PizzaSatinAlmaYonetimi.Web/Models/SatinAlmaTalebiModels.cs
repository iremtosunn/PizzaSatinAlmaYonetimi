...
public sealed record TalepListeSatiri(int TalepId,string TalepNo,string UrunAdi,decimal Miktar,string Birim,string TalepEden,DateTime TalepTarihi,string? Aciklama,string Durum);
...
public sealed class TalepFormModel
{
 ...
 [Range(typeof(decimal),"1","99999999",ErrorMessage="Miktar sÄ±fÄ±rdan bÃ¼yÃ¼k olmalÄ±dÄ±r.")]public decimal Miktar{get;set;}
...
public sealed class SatinAlmaTalepleriViewModel{public IReadOnlyList<TalepListeSatiri>Talepler{get;init;}=[];public TalepFiltreModel Filtre{get;init;}=new();public TalepFormModel Form{get;init;}=new();public string? AcikPanel{get;init;}}
