...
public sealed class TeklifFormModel
{
 ...
 [Required(ErrorMessage="Talep seÃ§imi zorunludur.")]public string TalepNo{get;set;}=string.Empty;
 public int? TedarikciId{get;set;}[Required(ErrorMessage="TedarikÃ§i seÃ§imi zorunludur.")]public string FirmaAdi{get;set;}=string.Empty;
 [Range(typeof(decimal),"1","999999999",ErrorMessage="Tutar sÄ±fÄ±rdan bÃ¼yÃ¼k olmalÄ±dÄ±r.")]public decimal Tutar{get;set;}
 [Range(1,3650,ErrorMessage="Teslim sÃ¼resi sÄ±fÄ±rdan bÃ¼yÃ¼k olmalÄ±dÄ±r.")]public int TeslimSuresiGun{get;set;}
 [DataType(DataType.Date)]public DateTime? Skt{get;set;}[Required(ErrorMessage="GeÃ§erlilik tarihi zorunludur.")][DataType(DataType.Date)]public DateTime? GecerlilikTarihi{get;set;}
